	...
	<div class="shareBlock wi-block--sharing">
		...
		if ( 'off' !== $webinar_data->ty_fb_share ) {
			...
			<div class="socialShare">
				<!-- <div class="fb-like" data-href="<?php// echo esc_url( get_permalink( $data->postID ) ); ?>"
					data-send="false"
		...
		if ( 'off' !== $webinar_data->ty_tw_share ) {
			...
			<div class="socialShare">
				<a href="https://twitter.com/share" class="twitter-share-button"
					...
					data-related="anywhereTheJavascriptAPI" data-count="vertical"><?php esc_html_e( 'Tweet', 'webinarignition' ); ?></a>
			</div>
			<div class="socialDivider"></div>
			<?php
		}
