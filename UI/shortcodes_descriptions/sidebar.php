...
if ( ! empty( $is_list ) ) {
	?><hr><p>
		<?php echo esc_html( 'Webinar Sidebar', 'webinarignition' ); ?>
	</p><?php
} else {
	?><?php
}
...
<p class="code-example">
	<span class="code-example-value">[wi_webinar_block id="<?php esc_html_e($webinarId); ?>" block="webinar_sidebar"]</span><!--
