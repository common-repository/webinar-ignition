...
if ( ! empty( $is_list ) ) {
	?><hr><p>
		<?php echo esc_html__( 'Countdown Counter', 'webinarignition' ); ?>
	</p><?php
} else {
	?><?php
}
...
<p class="code-example">
	<span class="code-example-value">[wi_webinar_block id="<?php echo esc_attr( $webinarId ); ?>" block="countdown_counter"]</span><!--
