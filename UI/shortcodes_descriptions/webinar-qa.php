...
if ( ! empty( $is_list ) ) {
	?><hr><p>
	<?php esc_html_e( 'Q&A section including section headings', 'webinarignition' ); ?>
	</p><?php
} else {
	?><?php
}
...
<p class="code-example">
	<span class="code-example-value">[wi_webinar_block id="<?php esc_html_e($webinarId); ?>" block="webinar_qa"]</span><!--
