...
if ( ! empty( $is_list ) ) {
	?><hr><p>
	<?php esc_html_e( 'Replay Call To Action section', 'webinarignition' ); ?>
	</p><?php
} else {
	?><?php
}
...
<p class="code-example">
	<span class="code-example-value">[wi_webinar_block id="<?php esc_html_e($webinarId); ?>" block="replay_cta"]</span><!--
