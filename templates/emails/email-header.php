...
<html lang="en" xmlns="https://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office">
					...
					<td align="center" style="padding:0;">
						...
						<?php if ( $img = (int) get_option( 'webinarignition_show_email_header_img' ) ) : ?>   
							...
							<tr id="template_header_image">
    							...
    							<img src="<?php echo esc_url( get_option( 'webinarignition_email_logo_url' ) ); ?>" 
        						 alt="" 
    ...
    <?php echo esc_html( ! empty( $email_data ) && ! empty( $email_data->emailheading ) ? $email_data->emailheading : __( 'Email Heading Text', 'webinarignition' ) ); ?></h1>
							</td>
						</tr>
