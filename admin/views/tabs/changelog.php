...
?>
	<style>
		#wi-plugin-information .section ul,
		#wi-plugin-information .section ol {
...
<?php
	echo esc_attr($changelog);
	$changelog_html = ob_get_clean();
} else {
	ob_start();
?>
	<iframe scrolling="no" width="100%" height="188200px" src="<?php echo esc_attr($changelog_link); ?>" title="<?php esc_attr_e('WebinarIgnition Support', 'webinarignition'); ?>" style="border:none;"></iframe>
...
<div id="wi-plugin-information" class="wrap">
	<div class="row">
		<div class="col-xs-12 col-md-8">
			<h1><?php echo esc_attr__('Changelog', 'webinarignition'); ?></h1>
		</div>
	</div>
